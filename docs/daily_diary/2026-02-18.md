...
Recent MLflow runs (experiment `586083506121040615`) from Feb 17–18 (UTC). All are **synthetic parenthesis**, **binary** target, **BCE** loss, **tile_size=256**, **batch_size=24**.

| Run ID (short) | End time (UTC) | lr    | output_activation | num_train | num_val | Notes |
|----------------|-----------------|-------|-------------------|----------|---------|--------|
| `5626ddf7`     | Feb 18 01:15   | 1e-6  | clamp             | 1854     | 397     | Earlier run. |
| `c08d3ae7`     | Feb 18 07:40   | 1e-7  | clamp             | 1854     | 397     | LR lowered to 1e-7. |
| `416a9b4b`     | Feb 18 16:17   | 1e-7  | sigmoid           | 1854     | 397     | Switched to sigmoid; full tile set. |
| `aee9a3e2`     | Feb 18 16:34   | 1e-7  | sigmoid           | 280      | 60      | Smaller dataset (280/60). |
| `70a6e8af`     | Feb 18 20:19   | 1e-7  | sigmoid           | 280      | 60      | Same as aee9a3e2; most recent. |
